...
# Setup alpine + docker swarm and run the docker stack

curl -sSL https://raw.githubusercontent.com/pascalandy/docker-stack-this/master/play-with-docker-init/alpine-setup.sh > alpine-setup.sh && sleep 2 && \
